...
def gamestate(board):
    ...
    for index,row in enumerate(board):
        ...
        # Wins per line
        winning_stats = [i+j for i,j in zip(winning_stats,is_winning(row))]
    ...
    for column in columns:
        winning_stats = [i+j for i,j in zip(winning_stats,is_winning(column))]

    # Diagonals
    for diagonal in diagonals:
        winning_stats = [i+j for i,j in zip(winning_stats,is_winning(diagonal))]
