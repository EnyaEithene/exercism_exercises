...
def approx_average_is_average(hand):
    ...
    middle = len(hand) // 2
    average2 = hand[middle]
    real_average = card_average(hand)
    return True if real_average in [average1,average2] else False
...
def average_even_is_average_odd(hand):
    ...
    average_odd = card_average(hand[1:len(hand):2])
    average_even = card_average(hand[0:len(hand):2])
